...
def export(cur, table, colname):
    ...
    for row in rows:
        ...
        if d_row[0] == None:
            None
        elif (len(d_row[0]) == 19 ) and (d_row[0][12] == "."):
            d_row[0] = str(str(d_row[0][0:2])+"년 " + str(d_row[0][2:4])+"월 " 
            + str(d_row[0][4:6])+"일 " + str(d_row[0][6:8])+"시 " + str(d_row[0][8:10])+"분 " + str(d_row[0][10:12])+"초")
