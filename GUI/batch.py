...
def LysnData(phoneNo):
    ...
    subprocess.call(f'adb pull /sdcard/Lysn C:/AppData/{phoneNo}', shell=True)
    subprocess.call('adb shell rm -rf /sdcard/Lysn', shell=True)
...
def TongTongData(phoneNo):
    ...
    subprocess.call(f'adb pull /sdcard/TongTong C:/AppData/{phoneNo}', shell=True)
...
def KakaoTalkData(phoneNo):
    ...
    subprocess.call(f'adb pull /sdcard/KakaoTalk C:/AppData/{phoneNo}', shell=True)
